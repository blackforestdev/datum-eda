...
BUDGETS: tuple[Budget, ...] = (
    ...
    Budget("crates/cli/src/cli_args_project_command_args_artifacts.rs", 782, mode="pre_test"),
    Budget("crates/cli/src/command_exec_project_query.rs", 1422, mode="pre_test"),
    ...
    Budget("crates/cli/src/main_route_proposal.rs", 1898, mode="pre_test"),
    ...
    Budget("crates/engine/src/pool/mod.rs", 382, mode="pre_test"),
    Budget("crates/gui-app/src/main.rs", 3229, mode="pre_test"),
    Budget("crates/gui-protocol/src/lib.rs", 7115, mode="pre_test"),
    Budget("crates/gui-render/src/lib.rs", 7767, mode="pre_test"),
    Budget("crates/test-harness/src/bin/m3_sidecar_roundtrip_fidelity.rs", 950, mode="total"),
    Budget("mcp-server/server_runtime.py", 993, mode="total"),
