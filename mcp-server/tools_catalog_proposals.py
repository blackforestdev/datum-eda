...
PROPOSAL_TOOL_SCHEMAS = {
    ...
    "create_pool_pin_pad_map_proposal": {
        "description": "Create a non-mutating draft proposal to author one first-class native pool PinPadMap.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "path": {"type": "string"},
        ...
        "x_dispatch_defaults": {"pool": "pool", "set_default": False},
    },
    "set_pool_pin_pad_map_proposal": {
        "description": "Create a non-mutating draft proposal to update first-class native pool PinPadMap mappings.",
        "inputSchema": {
            "type": "object",
            "properties": {
                "path": {"type": "string"},
