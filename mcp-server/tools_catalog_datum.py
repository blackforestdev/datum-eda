...
DATUM_TOOL_SPECS = [
    ...
    {"name": "datum.library.create_footprint", **datum_alias("create_pool_footprint", LIBRARY_TOOL_SCHEMAS["create_pool_footprint"])},
    {"name": "datum.library.set_footprint_pad", **datum_alias("set_pool_footprint_pad", LIBRARY_TOOL_SCHEMAS["set_pool_footprint_pad"])},
    {"name": "datum.library.set_footprint_courtyard_rect", **datum_alias("set_pool_footprint_courtyard_rect", LIBRARY_TOOL_SCHEMAS["set_pool_footprint_courtyard_rect"])},
    {"name": "datum.library.set_footprint_courtyard_polygon", **datum_alias("set_pool_footprint_courtyard_polygon", LIBRARY_TOOL_SCHEMAS["set_pool_footprint_courtyard_polygon"])},
    {"name": "datum.library.add_footprint_silkscreen_line", **datum_alias("add_pool_footprint_silkscreen_line", LIBRARY_TOOL_SCHEMAS["add_pool_footprint_silkscreen_line"])},
    {"name": "datum.library.add_footprint_silkscreen_rect", **datum_alias("add_pool_footprint_silkscreen_rect", LIBRARY_TOOL_SCHEMAS["add_pool_footprint_silkscreen_rect"])},
    {"name": "datum.library.add_footprint_silkscreen_circle", **datum_alias("add_pool_footprint_silkscreen_circle", LIBRARY_TOOL_SCHEMAS["add_pool_footprint_silkscreen_circle"])},
    {"name": "datum.library.add_footprint_silkscreen_polygon", **datum_alias("add_pool_footprint_silkscreen_polygon", LIBRARY_TOOL_SCHEMAS["add_pool_footprint_silkscreen_polygon"])},
    ...
    {"name": "datum.library.create_pin_pad_map", **datum_alias("create_pool_pin_pad_map", LIBRARY_TOOL_SCHEMAS["create_pool_pin_pad_map"])},
    {"name": "datum.library.set_pin_pad_map", **datum_alias("set_pool_pin_pad_map", LIBRARY_TOOL_SCHEMAS["set_pool_pin_pad_map"])},
    {"name": "datum.project.validate", **datum_alias("validate_project", {"description": "Validate one native project directory for required files, schema versions, UUID consistency, and persisted references.", "inputSchema": {"type": "object", "properties": {"path": {"type": "string"}}, "required": ["path"]}})},
    {"name": "datum.project.create_pool_pin_pad_map", **datum_alias("create_pool_pin_pad_map", LIBRARY_TOOL_SCHEMAS["create_pool_pin_pad_map"])},
    {"name": "datum.project.set_pool_pin_pad_map", **datum_alias("set_pool_pin_pad_map", LIBRARY_TOOL_SCHEMAS["set_pool_pin_pad_map"])},
    ...
    *[{"name": f"datum.schematic.{name}", **datum_alias(name, DATUM_SCHEMATIC_PRIMITIVE_SCHEMAS[f"datum.schematic.{name}"])} for name in DATUM_SCHEMATIC_SYMBOL_METADATA_METHODS],
    ...
    {"name": "datum.proposal.create_pool_footprint", **proposal_write_alias("create_pool_footprint_proposal", PROPOSAL_TOOL_SCHEMAS["create_pool_footprint_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.create_pool_pin_pad_map", **proposal_write_alias("create_pool_pin_pad_map_proposal", PROPOSAL_TOOL_SCHEMAS["create_pool_pin_pad_map_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.set_pool_pin_pad_map", **proposal_write_alias("set_pool_pin_pad_map_proposal", PROPOSAL_TOOL_SCHEMAS["set_pool_pin_pad_map_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.set_pool_footprint_pad", **proposal_write_alias("set_pool_footprint_pad_proposal", PROPOSAL_TOOL_SCHEMAS["set_pool_footprint_pad_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.set_pool_footprint_courtyard_rect", **proposal_write_alias("set_pool_footprint_courtyard_rect_proposal", PROPOSAL_TOOL_SCHEMAS["set_pool_footprint_courtyard_rect_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.set_pool_footprint_courtyard_polygon", **proposal_write_alias("set_pool_footprint_courtyard_polygon_proposal", PROPOSAL_TOOL_SCHEMAS["set_pool_footprint_courtyard_polygon_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.add_pool_footprint_silkscreen_line", **proposal_write_alias("add_pool_footprint_silkscreen_line_proposal", PROPOSAL_TOOL_SCHEMAS["add_pool_footprint_silkscreen_line_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.add_pool_footprint_silkscreen_rect", **proposal_write_alias("add_pool_footprint_silkscreen_rect_proposal", PROPOSAL_TOOL_SCHEMAS["add_pool_footprint_silkscreen_rect_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.add_pool_footprint_silkscreen_circle", **proposal_write_alias("add_pool_footprint_silkscreen_circle_proposal", PROPOSAL_TOOL_SCHEMAS["add_pool_footprint_silkscreen_circle_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
    {"name": "datum.proposal.add_pool_footprint_silkscreen_polygon", **proposal_write_alias("add_pool_footprint_silkscreen_polygon_proposal", PROPOSAL_TOOL_SCHEMAS["add_pool_footprint_silkscreen_polygon_proposal"], "proposal_metadata_write", PROPOSAL_METADATA_EVIDENCE)},
