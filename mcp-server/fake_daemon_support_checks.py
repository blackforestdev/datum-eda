    ...
    def generate_standards_repair_proposals(self, path: str) -> JsonRpcResponse:
        ...
        return JsonRpcResponse(
            ...
            131,
            {
                ...
                "proposals": [
                    {
                        "proposal_id": "proposal-pad-test",
                        "repair_kind": "process_aperture",
                        "affected_pad": "pad-test",
                        "finding_fingerprints": ["sha256:pad-finding-test"],
                        "codes": [
                            "pad_process_aperture_inherited_from_copper",
                            "pad_mask_expansion_missing",
                            "pad_paste_reduction_missing",
                        ],
                        "prepared_against": "model-test",
                        "prepared_against_current_model": True,
                        "can_apply": False,
                        "blocker_codes": ["missing_acceptance"],
                        "operations": 1,
                    },
                    {
                        "proposal_id": "proposal-zone-test",
                        "repair_kind": "zone_fill",
                        "affected_zone": "zone-test",
                        "finding_fingerprints": ["sha256:zone-finding-test"],
                        "codes": ["zone_fill_unfilled"],
                        "prepared_against": "model-test",
                        "prepared_against_current_model": True,
                        "can_apply": False,
                        "blocker_codes": ["missing_acceptance"],
