...
class TestDaemonClientLibraryRequests(unittest.TestCase):
    ...
    def test_creates_pool_part_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "create-pool-part", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--entity", "entity-test", "--package", "package-test", "--mpn", "OPA1656ID", "--manufacturer", "Texas Instruments", "--value", "OPA1656", "--description", "", "--datasheet", "", "--lifecycle", "Active"], capture_output=True, text=True, check=False)
    ...
    def test_sets_pool_part_metadata_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-metadata", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mpn", "OPA1656ID", "--manufacturer-jep106", "123", "--lifecycle", "Active"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_parametric_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-parametric", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--param", "gbw=53MHz", "--param", "slew_rate=24V/us"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_orderable_mpns_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-orderable-mpns", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--mpn", "OPA1656ID", "--mpn", "OPA1656IDR"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_tags_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-tags", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--tag", "audio", "--tag", "opamp"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_packaging_options_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-packaging-options", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--option", "kind=tape_reel;qty=2500", "--option", "{\"kind\":\"tray\",\"quantity\":90}"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_supply_chain_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-supply-chain", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--clear", "--checked-at", "2026-06-21T12:34:56Z", "--offer", "{\"supplier\":\"DigiKey\",\"sku\":\"296-OPA1656ID-ND\"}", "--offer", "{\"supplier\":\"Mouser\",\"sku\":\"595-OPA1656ID\"}"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_behavioural_models_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-behavioural-models", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--model", "{\"kind\":\"spice\",\"path\":\"models/opamp.lib\"}", "--model", "not-json"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_detaches_pool_part_model_by_attachment_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "detach-pool-part-model", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--attachment", "attachment-test"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_detaches_pool_part_model_by_model_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "detach-pool-part-model", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--model", "model-test"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_thermal_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-thermal", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--theta-ja-c-per-w", "42.5", "--theta-jc-top-c-per-w", "8.2", "--theta-jb-c-per-w", "12", "--max-junction-c", "150", "--thermal-reference", "JEDEC JESD51", "--clear"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_pad_map_entry_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-pad-map-entry", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--pad", "pad-test", "--gate", "gate-test", "--pin", "pin-test"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_part_pad_map_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-part-pad-map", "/tmp/native-project", "--pool", "pool", "--part", "part-test", "--mode", "replace", "--entry", "pad-test:gate-test:pin-test"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "part-test")
    ...
    def test_sets_pool_package_courtyard_polygon_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-package-courtyard-polygon", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--vertices", "0,0;1000,0;1000,1000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_adds_pool_package_silkscreen_line_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(
            args=[],
            returncode=0,
            stdout='{"action":"add_package_silkscreen_line","object_uuid":"package-test"}',
            stderr="",
        )
    ...
    def test_adds_pool_symbol_rect_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-symbol-rect", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--min-x-nm", "0", "--min-y-nm", "0", "--max-x-nm", "1000", "--max-y-nm", "2000", "--width-nm", "100"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")
    ...
    def test_adds_pool_symbol_circle_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-symbol-circle", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--center-x-nm", "500", "--center-y-nm", "600", "--radius-nm", "250", "--width-nm", "100"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")
    ...
    def test_adds_pool_symbol_polygon_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-symbol-polygon", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--vertices", "0,0;1000,0;1000,1000", "--closed", "true", "--width-nm", "150000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")
    ...
    def test_adds_pool_symbol_text_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-symbol-text", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--text", "REF**", "--x-nm", "1000", "--y-nm", "2000", "--rotation", "90"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")
    ...
    def test_sets_pool_symbol_pin_anchor_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-symbol-pin-anchor", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--pin", "pin-test", "--x-nm", "100", "--y-nm", "200"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")
    ...
    def test_adds_pool_package_silkscreen_rect_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(
            args=[], returncode=0,
            stdout='{"action":"add_package_silkscreen_rect","object_uuid":"package-test"}', stderr="",
        )
    ...
    def test_adds_pool_package_silkscreen_polygon_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(args=[], returncode=0, stdout='{"action":"add_package_silkscreen_polygon","object_uuid":"package-test"}', stderr="")
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-silkscreen-polygon", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--vertices", "0,0;1000,0;1000,1000", "--closed", "true", "--width-nm", "150000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_adds_pool_package_silkscreen_circle_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(
            args=[], returncode=0,
            stdout='{"action":"add_package_silkscreen_circle","object_uuid":"package-test"}', stderr="",
        )
    ...
    def test_adds_pool_package_silkscreen_arc_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(args=[], returncode=0, stdout='{"action":"add_package_silkscreen_arc","object_uuid":"package-test"}', stderr="")
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-silkscreen-arc", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--x-nm", "1000", "--y-nm", "2000", "--radius-nm", "3000", "--start-angle", "0", "--end-angle", "900", "--width-nm", "150000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_adds_pool_symbol_arc_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-symbol-arc", "/tmp/native-project", "--pool", "pool", "--symbol", "symbol-test", "--x-nm", "1000", "--y-nm", "2000", "--radius-nm", "3000", "--start-angle", "0", "--end-angle", "900", "--width-nm", "150000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "symbol-test")

    @patch("server_runtime.subprocess.run")
    def test_adds_pool_package_silkscreen_text_via_cli(self, run_mock) -> None:
        run_mock.return_value = subprocess.CompletedProcess(args=[], returncode=0, stdout='{"action":"add_package_silkscreen_text","object_uuid":"package-test"}', stderr="")
        response = EngineDaemonClient().add_pool_package_silkscreen_text("/tmp/native-project", "pool", "package-test", "REF**", 1000, 2000, 90)
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-silkscreen-text", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--text", "REF**", "--x-nm", "1000", "--y-nm", "2000", "--rotation", "90"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_adds_pool_package_model_3d_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-model-3d", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--model-path", "models/pkg.step", "--transform-json", "{\"scale\":1}"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_adds_pool_package_model_3d_without_transform_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-model-3d", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--model-path", "models/pkg.step"], capture_output=True, text=True, check=False)
    ...
    def test_adds_pool_package_model_3d_geometry_options_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "add-pool-package-model-3d", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--model-path", "models/pkg.step", "--format", "step", "--tx-nm", "10", "--ty-nm", "20", "--tz-nm", "30", "--roll-tenths-deg", "1", "--pitch-tenths-deg", "2", "--yaw-tenths-deg", "3", "--scale", "1.25"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_sets_pool_package_body_heights_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-package-body-heights", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--body-height-nm", "1000000", "--body-height-mounted-nm", "1200000"], capture_output=True, text=True, check=False)
        self.assertEqual(response.result["object_uuid"], "package-test")
    ...
    def test_clears_pool_package_body_heights_via_cli(self, run_mock) -> None:
        ...
        run_mock.assert_called_once_with(["datum-eda", "--format", "json", "project", "set-pool-package-body-heights", "/tmp/native-project", "--pool", "pool", "--package", "package-test", "--clear"], capture_output=True, text=True, check=False)
