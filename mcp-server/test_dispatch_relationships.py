        ...
        for tool_name, arguments, expected_call in [
            ...
            (
                "bind_component_instance",
                {
                    ...
                    "symbol": "sym-role",
                    "package": "pkg-role",
                    "symbol_roles": {"sym-role": {"role": "logical_unit", "label": "A"}},
                    "package_roles": {"pkg-role": {"role": "physical_package"}},
                },
                (
                    "bind_component_instance",
                    "/tmp/native-project",
                    ...
                    None,
                    None,
                    {"sym-role": {"role": "logical_unit", "label": "A"}},
                    {"pkg-role": {"role": "physical_package"}},
                ),
            ),
            (
    ...
    def test_tools_call_dispatches_canonical_component_instance_aliases(self) -> None:
        ...
        for tool_name, arguments, expected_method in [
            ...
            (
                ...
                {"path": "/tmp/native-project", "symbols": ["sym-a", "sym-b"], "package": "pkg-test"},
                "bind_component_instance",
            ),
            (
