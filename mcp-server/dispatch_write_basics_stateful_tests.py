#!/usr/bin/env python3
"""Write-surface MCP dispatch tests for stateful follow-up behavior."""
...
class TestDispatchWriteBasicsStateful(unittest.TestCase):
                ...
                return JsonRpcResponse(
                    ...
                    2,
                    {
                        ...
                        "summary": {
                            ...
                            "by_code": [
                                {
                                    "code": "net_without_copper"
                                    if self.deleted
                                    else "partially_routed_net",
                                    "count": 1,
                                }
                            ],
                        },
