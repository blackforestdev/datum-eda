...
- **Decide adopted drafting-standard object ownership** (`DRAFTING-STANDARD-AUTHORITY`; `dat-drafting-standard-authority-jcz`).
   ...
   *Dependencies:* none. *Unblocks:* dat-global-preferences-engine-qcv. *Governing:* `research/documentation-system/DRAFTING_STANDARD_OWNERSHIP_DECISION_PACKET.md`, `docs/decisions/PRODUCT_MECHANICS_010_INDUSTRY_STANDARDS_COMPLIANCE.md`, `docs/decisions/PRODUCT_MECHANICS_020_PAPER_SPACE_AND_VIEWPORTS.md`, `docs/decisions/PRODUCT_MECHANICS_034_PRODUCT_REVISION_ENGINE.md`, `specs/PUBLISH_SPACE_SPEC.md`, `specs/STANDARDS_COMPLIANCE_SPEC.md`, `docs/gui/DATUM_RENDERING_BOOK.md`, `docs/gui/prototypes/preferences-window.html`.
