...
- **Specify the Datum Global Preferences Engine** (`GLOBAL-PREFERENCES-SPEC`; `dat-global-preferences-engine-qcv`).
   ...
   *Dependencies:* `dat-product-revision-engine-k9f`. *Unblocks:* dat-product-revision-engine-build-18f. *Governing:* `research/preferences-system/GLOBAL_PREFERENCES_ENGINE_RESEARCH.md`, `research/preferences-system/GP_C02B_DOMAIN_PEER_PREFERENCES_RESEARCH.md`, `research/preferences-system/GP_C03_TYPED_AUTHORITY_DECISION_PACKET.md`, `research/preferences-system/GP_C03_PROJECT_SEED_AND_CONTEXT_DECISION_PACKET.md`, `research/preferences-system/GP_DRAFT_SETTINGS_CATALOG_SEED.md`, `docs/gui/prototypes/preferences-ux-study.html`, `docs/gui/prototypes/preferences-window.html`, `research/documentation-system/PRODUCT_REVISION_ENGINE_RESEARCH.md`, `docs/gui/DATUM_GUI_PRODUCT_SPEC.md`.
