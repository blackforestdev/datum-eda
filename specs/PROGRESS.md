...
- **Specify the Datum Global Preferences Engine** (`GLOBAL-PREFERENCES-SPEC`; `dat-global-preferences-engine-qcv`).
   ...
   *Dependencies:* `dat-product-revision-engine-k9f`. *Unblocks:* dat-product-revision-engine-build-18f. *Governing:* `research/preferences-system/GLOBAL_PREFERENCES_ENGINE_RESEARCH.md`, `research/preferences-system/GP_C02B_DOMAIN_PEER_PREFERENCES_RESEARCH.md`, `research/preferences-system/GP_C03_TYPED_AUTHORITY_DECISION_PACKET.md`, `research/preferences-system/GP_C03_PROJECT_SEED_AND_CONTEXT_DECISION_PACKET.md`, `research/preferences-system/GP_DRAFT_SETTINGS_CATALOG_SEED.md`, `research/preferences-system/GP_SHARED_UNITS_ENGINE_REQUIREMENT.md`, `research/documentation-system/DRAFTING_STANDARD_OWNERSHIP_DECISION_PACKET.md`, `docs/gui/prototypes/preferences-ux-study.html`, `docs/gui/prototypes/preferences-window.html`, `research/documentation-system/PRODUCT_REVISION_ENGINE_RESEARCH.md`, `docs/gui/DATUM_GUI_PRODUCT_SPEC.md`.
...
- **Decide adopted drafting-standard object ownership** (`DRAFTING-STANDARD-AUTHORITY`; `dat-drafting-standard-authority-jcz`).
   Owner decision packet for the authority that adopts a drafting-standard object for a Project. The packet distinguishes projection angle, dimensioning conventions, and sheet symbology from Product Mechanics 034 revision coding; it authorizes no implementation or dependency. *state `planned`; authorization `planning`.*
   *Dependencies:* none. *Unblocks:* dat-global-preferences-engine-qcv. *Governing:* `research/documentation-system/DRAFTING_STANDARD_OWNERSHIP_DECISION_PACKET.md`, `docs/decisions/PRODUCT_MECHANICS_035_ADOPTED_DRAFTING_STANDARD_AUTHORITY.md`, `docs/decisions/PRODUCT_MECHANICS_010_INDUSTRY_STANDARDS_COMPLIANCE.md`, `docs/decisions/PRODUCT_MECHANICS_020_PAPER_SPACE_AND_VIEWPORTS.md`, `docs/decisions/PRODUCT_MECHANICS_034_PRODUCT_REVISION_ENGINE.md`, `specs/PUBLISH_SPACE_SPEC.md`, `specs/STANDARDS_COMPLIANCE_SPEC.md`, `docs/gui/DATUM_RENDERING_BOOK.md`, `docs/gui/prototypes/preferences-window.html`.
- **Resolve schematic canvas background authority** (`SCHEMATIC-BACKGROUND-OWNER-DECISION`; `dat-schematic-background-owner-decision-gom`).
   Parked owner decision over the schematic paper-like background candidate and the locked dark-default rendering authority. No research, prototype change, specification clause, or implementation is authorized until the owner explicitly resumes it. *state `planned`; authorization `none`.*
   *Dependencies:* none. *Unblocks:* none. *Governing:* `docs/gui/prototypes/preferences-window.html`, `docs/gui/DATUM_RENDERING_BOOK.md`.
- **Specify the adopted drafting-standard object** (`ADOPTED-DRAFTING-STANDARD-SPEC`; `dat-adopted-drafting-standard-object-er9`).
   Specify the documentation-system-owned Project drafting-standard object, its StandardsRegistry references, typed authority, Publish/template seams, migration, provenance, and receipted Global Preferences new-Project seed without authorizing implementation. *state `blocked`; authorization `planning`.*
