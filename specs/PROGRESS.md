...
- **Specify the Datum Global Preferences Engine** (`GLOBAL-PREFERENCES-SPEC`; `dat-global-preferences-engine-qcv`).
   ...
   *Dependencies:* `dat-product-revision-engine-k9f`. *Unblocks:* revision-policy system selection and governed global Preferences implementation, dat-product-revision-engine-build-18f. *Governing:* `research/documentation-system/PRODUCT_REVISION_ENGINE_RESEARCH.md`, `docs/gui/DATUM_GUI_PRODUCT_SPEC.md`.
