...
- **Build and production-accept the shared Units engine** (`SHARED-UNITS-ENGINE`; `dat-shared-units-engine-build-915`).
   Implement one cross-cutting engine-owned exact Units service for integer-nanometer storage truth and shared typed format/parse behavior before Global Preferences execution, with every slice separately authorized. *state `specified`; authorization `owner_decision`.*
   *Dependencies:* `dat-global-preferences-engine-qcv`. *Unblocks:* dat-global-preferences-engine-build-vge. *Governing:* `docs/decisions/PRODUCT_MECHANICS_037_GLOBAL_PREFERENCES_ENGINE.md`, `research/preferences-system/GP_SHARED_UNITS_ENGINE_REQUIREMENT.md`, `specs/GLOBAL_PREFERENCES_ENGINE_IMPLEMENTATION_PLAN.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`.
- **Build and production-accept the Global Preferences Engine** (`GLOBAL-PREFERENCES-ENGINE`; `dat-global-preferences-engine-build-vge`).
   Implement PM-037 through separately authorized typed resolver, repository/migration/recovery, copy-once Project seeding, product-surface parity, ratified wgpu visual/accessibility, real-project, and production-acceptance slices. *state `blocked`; authorization `owner_decision`.*
   *Dependencies:* `dat-global-preferences-engine-qcv`, `dat-shared-units-engine-build-915`. *Unblocks:* none. *Governing:* `docs/decisions/PRODUCT_MECHANICS_037_GLOBAL_PREFERENCES_ENGINE.md`, `specs/GLOBAL_PREFERENCES_V1_DESCRIPTOR_CATALOG.md`, `research/preferences-system/GP_C04_STORAGE_MIGRATION_EXCHANGE_RECOVERY_CONTRACT.md`, `research/preferences-system/GP_C05_INTERACTION_AND_VISUAL_CONTRACT.md`, `specs/GLOBAL_PREFERENCES_ENGINE_IMPLEMENTATION_PLAN.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`, `docs/gui/prototypes/preferences-window.html`.
- **Build and production-accept the Datum Product Revision Engine** (`PRODUCT-REVISION-ENGINE`; `dat-product-revision-engine-build-18f`).
   ...
   *Dependencies:* `dat-product-revision-engine-k9f`, `dat-global-preferences-engine-qcv`. *Unblocks:* none. *Governing:* `docs/decisions/PRODUCT_MECHANICS_034_PRODUCT_REVISION_ENGINE.md`, `specs/PRODUCT_REVISION_ENGINE_SPEC.md`, `specs/PRODUCT_REVISION_ENGINE_IMPLEMENTATION_PLAN.md`, `research/documentation-system/REV_I00_EXECUTION_AUTHORIZATION_PACKET.md`, `research/documentation-system/REV_I02_EXECUTION_AUTHORIZATION_PACKET.md`, `research/documentation-system/REV_I03_EXECUTION_AUTHORIZATION_PACKET.md`, `research/documentation-system/REV_I04_EXECUTION_AUTHORIZATION_PACKET.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`.
...
- **Recover the Revision product baseline and contain rejected REV-I10** (`REVISION-PRODUCT-RECOVERY`; `dat-revision-product-recovery-dap`).
   Apply the owner-approved manual-first product baseline, supersede permanent unmanaged Revision presentation, quarantine unvalidated implementation breadth, remove fictional runtime records, and require a small comprehensible owner review before any wider Revision execution resumes. *state `in_progress`; authorization `planning`; **CANONICAL NEXT**.*
   *Dependencies:* none. *Unblocks:* none. *Governing:* `docs/decisions/PRODUCT_MECHANICS_038_REVISION_RECOVERY_AND_PRODUCT_BASELINE.md`, `docs/decisions/PRODUCT_MECHANICS_034_PRODUCT_REVISION_ENGINE.md`, `docs/decisions/PRODUCT_MECHANICS_037_GLOBAL_PREFERENCES_ENGINE.md`, `specs/PRODUCT_REVISION_ENGINE_SPEC.md`, `specs/PRODUCT_REVISION_ENGINE_IMPLEMENTATION_PLAN.md`, `docs/PROJECT_STATE_POLICY.md`.
