...
- **Harden the Datum-owned PTY transport** (`TERMINAL-T1-PTY`; `dat-terminal-emulator-epic-jzv.1`).
   Restore and harden Datum-owned Linux PTY/session transport with no third-party terminal dependency. *state `ready`; authorization `execution`; **CANONICAL NEXT**.*
   *Dependencies:* `dat-pan-trace-terminal-pollution-0j0`. *Unblocks:* dat-terminal-emulator-epic-jzv.2, dat-terminal-emulator-epic-jzv.3. *Governing:* `docs/decisions/PRODUCT_MECHANICS_027_FULL_NATIVE_TERMINAL.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`, `docs/gui/DATUM_NATIVE_TERMINAL_SPEC.md`.
...
- **Build the Datum-owned TerminalCore** (`TERMINAL-T1-CORE`; `dat-terminal-emulator-epic-jzv.2`).
   ...
   *Dependencies:* `dat-pan-trace-terminal-pollution-0j0`, `dat-terminal-emulator-epic-jzv.1`. *Unblocks:* dat-terminal-emulator-epic-jzv.3. *Governing:* `docs/decisions/PRODUCT_MECHANICS_027_FULL_NATIVE_TERMINAL.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`, `docs/gui/DATUM_NATIVE_TERMINAL_SPEC.md`.
