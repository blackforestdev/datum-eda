...
- **Build and stabilize Project Preferences** (`PROJECT-PREFERENCES-BUILD`; `dat-project-preferences-build-tlq`).
   ...
   *Dependencies:* `dat-project-preferences-spec-kiw`. *Unblocks:* none. *Governing:* `docs/decisions/PRODUCT_MECHANICS_039_PREFERENCES_FIRST_SETTINGS_ENTRY.md`, `specs/PROJECT_PREFERENCES_SPEC.md`, `docs/decisions/PRODUCT_MECHANICS_029_DEPENDENCY_AUTHORITY.md`, `docs/gui/prototypes/preferences-window.html`.
...
- **Implement broader workflow delivery enforcement and measured adoption** (`WORKFLOW-DELIVERY-IMPLEMENTATION`; `dat-wdq-rollout-implementation-ffy`).
   WDQ-RECHECK is technically complete: 1314 exact independent observations, 45 current-source focused tests, typed review of packet fa0b802e and renewed supported inspection of real-main descendant 992ce4f4 passed. Eight of eleven steps are complete. Claim-free WDQ-I04 now requires owner disposition of five findings and bounded preparation of a separate exact mechanism/activation packet; 992ce is not activation-ready. Product ownership, installed trust, three actual adoption cohorts and final acceptance remain unchanged. *state `specified`; authorization `owner_decision`; parallel lane.*
   *Dependencies:* none. *Unblocks:* none. *Governing:* `specs/WORKFLOW_DELIVERY_EXECUTION_PLAN.md`, `specs/WORKFLOW_DELIVERY_INFRASTRUCTURE_CONTRACT.md`, `specs/workflow_delivery/rollout.contract.json`, `specs/WORKFLOW_DELIVERY_COVERAGE_PROPOSAL.md`, `docs/reviews/workflow-delivery-rollout/coverage-proposal.json`, `research/process-quality/WORKFLOW_COHORT_CONTRACT_PREPARATION.md`, `docs/reviews/workflow-delivery-rollout/cohort-mappings.json`, `specs/workflow_delivery/s5a.contract.json`, `specs/workflow_delivery/gui-write-path.contract.json`, `specs/workflow_delivery/native-authoring.contract.json`, `specs/WORKFLOW_DELIVERY_ROLLOUT_IMPLEMENTATION.md`, `specs/WORKFLOW_DELIVERY_ROLLOUT_PLAN.md`, `docs/reviews/workflow-delivery-rollout/infrastructure/independent/review-completion.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/owner-dispositions.md`, `docs/reviews/workflow-delivery-rollout/infrastructure/final-publication/producer-inspection.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-repair-authorization.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/producer-closeout.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/index-repair-authorization.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/proof-renewal-authorization.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/index-repair-producer-closeout.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/sequencing-repair-authorization.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/sequencing-producer-closeout.json`, `docs/reviews/workflow-delivery-rollout/infrastructure/workspace-renewal/sequencing-independent-closeout.json`.
<!-- ACTIVE FRONTIER:END -->
...
| --- | --- | --- |
| `specs/WORKFLOW_DELIVERY_INFRASTRUCTURE_CONTRACT.md`, `specs/workflow_delivery/rollout.contract.json`, `docs/reviews/workflow-delivery-rollout/tooling-closeout.json`, `docs/reviews/workflow-delivery-rollout/readiness-review.json` | WDQ-TOOLS and WDQ-READY complete for retained candidate `f2e28a572b09296986d4748d456ef8bf5bd4c568`: constructed tooling, explicit ready-phase validation, exact authority/input/environment hashes, actual handler definitions and bounded named-tool review. Candidate code remains uninstalled. | `dat-wdq-rollout-implementation-ffy` remains open. WDQ-I03 is selected for complete final producer verification. Distinct replay, exact owner activation and three genuine product-adoption cohorts remain due; infrastructure readiness does not assert product readiness or acceptance. |
