...
| `docs/decisions/PRODUCT_MECHANICS_045_SHARED_GUI_PERFORMANCE.md` | Proposed shared ownership/reuse/adoption and limited qualification decision; C05 complete, exact packet awaits C06 owner approval | C06 actual owner ratification, separately from implementation acceptance |
