...
| `datum.projects.template_seed` | Project genesis | resolvable template identity or none; Datum starter | PS; U; R,C,Pn,L | seed:`ProjectTemplateCopy`; New Project only | P0; no legacy; I | `preferences-window.html:247` |
