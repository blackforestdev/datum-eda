...
out=Path(tempfile.mkdtemp(prefix='pm045-stroke-native-')); print(out,flush=True)
...
report['source_state']='Stroke conversion baseline d0777db0 versus bounded candidate; baseline source hashes describe candidate checkout, baseline bytes separately pinned'
