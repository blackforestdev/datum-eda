...
out=Path(tempfile.mkdtemp(prefix='pm045-x11-close-v3-'));print(out,flush=True)
...
env.update(LD_AUDIT='/tmp/pm045_x11_audit_v3.so',PM045_X11_AUDIT_PATH=str(out/'x11'))
