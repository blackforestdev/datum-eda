...
out=Path(tempfile.mkdtemp(prefix='pm045-read-cache-off-')); print(out,flush=True)
...
report['limits'].append('Opening timer ends at mapping/title/focus, not verified first presentation; lower-bound CPU observation only.')
