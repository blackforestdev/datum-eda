...
for name in ['<eda_engine::substrate::project_read_cache::ProjectReadCache>::resolve','eda_engine::substrate::project_read_cache::scan','<eda_engine::substrate::ProjectResolver>::resolve']:
 Begin(name)
