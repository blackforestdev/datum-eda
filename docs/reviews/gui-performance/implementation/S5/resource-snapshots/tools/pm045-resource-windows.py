...
out=Path(tempfile.mkdtemp(prefix='pm045-resource-windows-')); print(out,flush=True)
...
report['source_state']='Uncommitted bounded S5 resource-snapshot candidate; exact declaration hashes govern'
