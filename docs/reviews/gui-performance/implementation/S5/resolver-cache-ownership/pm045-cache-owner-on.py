...
out=Path(tempfile.mkdtemp(prefix='pm045-cache-owner-on-')); print(out,flush=True)
...
report['source_state']='Uncommitted GUI resolver allocation owner and retention ceiling on recorded HEAD'
