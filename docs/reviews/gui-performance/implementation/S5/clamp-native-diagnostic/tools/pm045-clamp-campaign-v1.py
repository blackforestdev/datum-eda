...
source=json.loads(Path('/tmp/pm045-resource-campaign-jksuuoyg/declaration.json').read_text())['source_sha256'];r={'purpose':'W-CLAMP bothbounds perlaunch,100untimedoutwarddetents,5warm,30s60Hzoutward,5still,separateoneinwardpositive. Three baseline/candidatepairs,notfullcamera state/method qualification. Historicaldrivercontext: W-POINTER native120Hz30s400x240rectangle,5swarmup/idle tail;three baseline/candidatepairs andone separatecandidateGPUtimestampdiagnostic;no relativeSTATacceptance. IntegerXTestpositionsroundplannedcoordinates;duplicates/coalescingmustbereported.','order':[['baseline',1,0],['candidate',1,0],['candidate',2,0],['baseline',2,0],['baseline',3,0],['candidate',3,0]],'source_sha256':source,'binary_sha256':{k:sha(v) for k,v in binaries.items()},'input_driver_sha256':sha('/tmp/pm045-wheel-stream.py'),'native_driver_sha256':sha('/tmp/pm045-clamp-native.py'),'runs':[]}
