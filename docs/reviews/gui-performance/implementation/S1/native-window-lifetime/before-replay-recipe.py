...
root=Path('/home/bfadmin/Documents/datum-eda');binary=root/'target/release/datum-gui';out=Path('/tmp/pm045-wayland-owner-close-replay');out.mkdir(exist_ok=False)
def lines(log):
