...
env=dict(os.environ,LD_PRELOAD='/tmp/datum_ioctl_probe.so',TMPDIR=str(out),XDG_CONFIG_HOME=str(out/'config'),XDG_CACHE_HOME=str(out/'cache'),EDA_CLI_BIN=str(root/'target/debug/datum-eda'),DATUM_GUI_VERBOSE_LOG='1',DATUM_TRACE_TIMING='1',DATUM_DIAGNOSTIC_NATIVE_FRAME=a.mode)
