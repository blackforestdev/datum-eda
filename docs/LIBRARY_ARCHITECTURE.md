...
### 1. Horizon's library architecture is the strongest structural reference

[HORIZON_ANALYSIS.md](/home/bfadmin/Documents/datum-eda/docs/HORIZON_ANALYSIS.md)
shows the right architectural separation:
...
Datum should adopt this style of model.
...
- owns footprint graphics, pads, courtyard, fab/silkscreen/mechanical layers,
  assembly cues, and 3D references
...
- binds entity to package
- owns explicit pad-to-pin mapping
