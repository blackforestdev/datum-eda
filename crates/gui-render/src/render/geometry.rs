#[path = "projected_polygon.rs"]
mod projected_polygon;
use projected_polygon::push_projected_polygon_fill_scanline_contours;
...
mod text_metrics;
use text_metrics::{measured_text_run_width_px, text_attrs, text_color, try_load_datum_fonts};
...
#[path = "text_presentation.rs"]
mod text_presentation;
use text_presentation::{estimated_text_run_width_px, scale_text_run_sizes, truncate_text};
...
#[cfg(test)]
use text_metrics::load_datum_fonts;
