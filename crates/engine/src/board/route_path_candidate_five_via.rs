...
pub struct RoutePathCandidateFiveViaSegment {
    pub layer: LayerId,
    pub points: Vec<Point>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateFiveViaPath {
    pub via_a_uuid: Uuid,
    ...
    pub segments: Vec<RoutePathCandidateFiveViaSegment>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateFiveViaSummary {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateFiveViaReport {
    pub contract: String,
    ...
    pub summary: RoutePathCandidateFiveViaSummary,
    pub path: Option<RoutePathCandidateFiveViaPath>,
}

impl Board {
    pub fn route_path_candidate_five_via(
        &self,
        net_uuid: Uuid,
        from_anchor_pad_uuid: Uuid,
        to_anchor_pad_uuid: Uuid,
    ) -> Result<RoutePathCandidateFiveViaReport, RoutePathCandidateError> {
        ...
        let blocked_via_quintuple_count = matching_quintuples
            .iter()
            .filter(|entry| {
        ...
        let selected_path = selected_matching_five_via(&matching_quintuples).map(|entry| {
            ...
            RoutePathCandidateFiveViaPath {
                ...
                segments: vec![
                    RoutePathCandidateFiveViaSegment {
        ...
        Ok(RoutePathCandidateFiveViaReport {
            contract: "m5_route_path_candidate_five_via_v1".to_string(),
            persisted_native_board_state_only: true,
            selection_rule: ROUTE_PATH_CANDIDATE_FIVE_VIA_SELECTION_RULE.to_string(),
            status,
