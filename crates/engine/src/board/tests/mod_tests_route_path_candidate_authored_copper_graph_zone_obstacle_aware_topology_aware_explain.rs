...
#[test]
fn topology_aware_explain_reports_selected_path_and_topology_reason() {
    ...
    let board = Board {
        uuid: Uuid::new_v4(),
        name: "topology-aware-explain".into(),
        stackup: Stackup {
            layers: vec![
                StackupLayer {
                    id: 1,
...
#[test]
fn topology_aware_explain_reports_no_existing_path_when_all_candidates_blocked() {
    let net_uuid = Uuid::new_v4();
    let class_uuid = Uuid::new_v4();
    let from_pad_uuid = Uuid::new_v4();
    let to_pad_uuid = Uuid::new_v4();
    ...
    let board = Board {
        uuid: Uuid::new_v4(),
        name: "topology-aware-explain-blocked".into(),
        stackup: Stackup {
