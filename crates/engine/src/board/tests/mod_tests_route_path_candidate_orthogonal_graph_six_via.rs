...
#[test]
fn route_path_candidate_orthogonal_graph_six_via_reports_deterministic_path() {
    let (
        board,
        net_uuid,
        _,
...
#[test]
fn route_path_candidate_orthogonal_graph_six_via_reports_no_path_when_middle_layer_is_cut() {
    let (
        mut board,
        net_uuid,
        other_net_uuid,
    ...
    assert_eq!(report.summary.available_via_sextuple_count, 0);
