...
#[test]
fn route_path_candidate_orthogonal_graph_five_via_reports_deterministic_path() {
    let (
        board,
        net_uuid,
        _,
...
#[test]
fn route_path_candidate_orthogonal_graph_five_via_reports_no_path_when_middle_layer_is_cut() {
    ...
    assert_eq!(report.summary.available_via_quintuple_count, 0);
