...
fn zone_demo_board() -> (Board, Uuid, Uuid, Uuid, Uuid, Uuid, Uuid) {
    let net_uuid = Uuid::from_u128(0x3400);
    let other_net_uuid = Uuid::from_u128(0x3401);
    let class_uuid = Uuid::from_u128(0x3402);
    let anchor_a_uuid = Uuid::from_u128(0x3403);
    let anchor_b_uuid = Uuid::from_u128(0x3404);
    let zone_uuid = Uuid::from_u128(0x3405);
    let track_uuid = Uuid::from_u128(0x3406);
    (
        Board {
            uuid: Uuid::new_v4(),
            name: "path-candidate-authored-copper-graph-zone-aware".into(),
            stackup: Stackup {
...
#[test]
fn route_path_candidate_authored_copper_graph_zone_aware_reports_zone_supported_path() {
    ...
    assert_eq!(
        ...
        Some(RoutePathCandidateAuthoredCopperGraphZoneAwareStepKindView::Zone)
    );
}
...
fn route_path_candidate_authored_copper_graph_zone_aware_reports_no_path_when_zone_does_not_bridge_anchors(
    ...
    board.zones.insert(
        ...
        Zone {
            ...
            polygon: Polygon::new(vec![
                Point::new(50_000, 50_000),
                Point::new(200_000, 50_000),
                Point::new(200_000, 150_000),
                Point::new(50_000, 150_000),
            ]),
            layer: 1,
            priority: 1,
