...
pub enum RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainKind
{
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainStep
{
    pub kind:
        super::route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware_layer_balance_aware::RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareStepKindView,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainSelectedPath
{
    pub steps: Vec<
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainSummary
{
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainReport
{
    pub contract: String,
...
impl Board {
    pub fn route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware_layer_balance_aware_explain(
        &self,
        net_uuid: Uuid,
        ...
        let selected_path = path_candidate.path.as_ref().map(|path| {
            RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainSelectedPath {
                ...
                selection_reason: format!(
                    "selected because it is the first unblocked persisted target-net authored-copper path under the explicit whole-path ordering rule (step_count, topology_transition_count, layer_balance_score, via_step_count, zone_step_count, step_signature_sequence), with {} step(s), {} topology transition(s), layer balance score {}, {} via step(s), and {} zone step(s)",
                    path.steps.len(),
                    path_candidate.summary.topology_transition_count,
                    path_candidate.summary.layer_balance_score,
            ...
            RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainReport {
                ...
                summary:
                    RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareLayerBalanceAwareExplainSummary {
                        ...
                        layer_balance_score: path_candidate.summary.layer_balance_score,
