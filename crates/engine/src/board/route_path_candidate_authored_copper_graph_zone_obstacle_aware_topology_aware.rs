...
use super::route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware_selection::{
    AuthoredCopperGraphZoneObstacleAwareTopologyAwareStepKind,
    ROUTE_PATH_CANDIDATE_AUTHORED_COPPER_GRAPH_ZONE_OBSTACLE_AWARE_TOPOLOGY_AWARE_SELECTION_RULE,
    selected_authored_copper_graph_zone_obstacle_aware_topology_aware_path,
};

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareStepKindView {
    Track,
    Via,
    Zone,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareStep {
    pub kind: RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareStepKindView,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwarePath {
    pub steps: Vec<RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareStep>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareSummary {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareReport {
    pub contract: String,
    ...
    pub summary: RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareSummary,
    pub path: Option<RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwarePath>,
}

impl Board {
    pub fn route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware(
        &self,
        net_uuid: Uuid,
    ...
    ) -> Result<RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareReport, RoutePathCandidateError>
    {
        ...
        let topology_transition_count = selected_path_match
            .as_ref()
            .map(|entry| entry.topology_transition_count)
            .unwrap_or(0);
        let path_via_step_count = selected_path_match
            .as_ref()
            .map(|entry| entry.via_step_count)
            .unwrap_or(0);
        let path_zone_step_count = selected_path_match
            .as_ref()
            .map(|entry| entry.zone_step_count)
            .unwrap_or(0);
                    ...
                    .map(|step| {
                        RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareStep {
                            kind: match step.kind {
                                AuthoredCopperGraphZoneObstacleAwareTopologyAwareStepKind::Track => {
