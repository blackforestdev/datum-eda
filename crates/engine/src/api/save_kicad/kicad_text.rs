...
pub(super) fn remove_kicad_top_level_forms(
...
pub(super) fn rewrite_moved_footprints(
    contents: &str,
...
pub(super) fn rewrite_value_footprints(
    contents: &str,
...
pub(super) fn rewrite_reference_footprints(
    contents: &str,
...
pub(super) fn rewrite_package_footprints(
    contents: &str,
    board: &Board,
    pool: &Pool,
    ...
    for component_uuid in component_uuids {
        ...
        updated =
            replace_kicad_top_level_form(&updated, "footprint", *component_uuid, &replacement)?;
    }
    Ok(updated)
}
