...
// live outside this family. zone_fill_context.rs stays a #[path] child of
// routing_net.rs — it is deliberately not declared here.
//
...
pub(crate) use self::component_mutations::{
    ...
    place_native_project_board_component, set_native_project_board_component_package,
...
pub(crate) use self::routing_net::{
    delete_native_project_board_track, delete_native_project_board_via,
    delete_native_project_board_zone, edit_native_project_board_track,
    edit_native_project_board_via, edit_native_project_board_zone, fill_native_project_zones,
