...
pub(crate) fn component_has_persisted_silkscreen(
    project: &LoadedNativeProject,
    component_key: &str,
) -> bool {
...
pub(crate) fn component_has_persisted_mechanical(
    project: &LoadedNativeProject,
    component_key: &str,
) -> bool {
...
pub(crate) fn component_model_count(project: &LoadedNativeProject, component_key: &str) -> usize {
    project
        .board
        .component_models_3d
        .get(component_key)
...
pub(crate) fn component_package_pad_count(
    project: &LoadedNativeProject,
    component_key: &str,
) -> usize {
    project
