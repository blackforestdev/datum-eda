...
pub(crate) fn native_sheet_into_engine_sheet(native_sheet: NativeSheetRoot) -> Sheet {
    Sheet {
...
pub(crate) fn json_object_len(value: &serde_json::Value, key: &str) -> usize {
    value
        .get(key)
...
pub(crate) fn render_label_kind(kind: &LabelKind) -> &'static str {
    match kind {
...
pub(crate) fn render_port_direction(direction: &PortDirection) -> &'static str {
    match direction {
...
pub(crate) fn load_native_label_mutation_target(
...
pub(crate) fn load_native_symbol_mutation_target(
    project: &LoadedNativeProject,
    symbol_uuid: Uuid,
...
pub(crate) fn load_native_field_mutation_target(
    project: &LoadedNativeProject,
    field_uuid: Uuid,
) -> Result<(
    Uuid,
...
pub(crate) fn load_native_text_mutation_target(
    project: &LoadedNativeProject,
    text_uuid: Uuid,
...
pub(crate) fn load_native_drawing_mutation_target(
    project: &LoadedNativeProject,
    drawing_uuid: Uuid,
) -> Result<(
    Uuid,
...
pub(crate) fn drawing_uuid(drawing: &SchematicPrimitive) -> Uuid {
    match drawing {
...
pub(crate) fn render_drawing_query_view(
    sheet_uuid: Uuid,
...
pub(crate) fn load_native_wire_mutation_target(
    project: &LoadedNativeProject,
    wire_uuid: Uuid,
...
pub(crate) fn load_native_junction_mutation_target(
    project: &LoadedNativeProject,
    junction_uuid: Uuid,
...
pub(crate) fn load_native_port_mutation_target(
    project: &LoadedNativeProject,
    port_uuid: Uuid,
) -> Result<(
    Uuid,
...
pub(crate) fn load_native_bus_mutation_target(
    project: &LoadedNativeProject,
    bus_uuid: Uuid,
...
pub(crate) fn load_native_bus_entry_mutation_target(
    project: &LoadedNativeProject,
    bus_entry_uuid: Uuid,
...
pub(crate) fn load_native_noconnect_mutation_target(
    project: &LoadedNativeProject,
    noconnect_uuid: Uuid,
