...
pub(crate) struct NativeProjectSheetMutationReportView {
    ...
    pub(crate) modified_ids: Vec<String>,
...
pub(crate) fn render_native_project_sheet_mutation_text(
    ...
    [
        ...
        format!("model_revision: {}", report.model_revision),
        format!("created_ids: {}", report.created_ids.join(",")),
        format!("modified_ids: {}", report.modified_ids.join(",")),
