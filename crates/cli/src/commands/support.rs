...
pub(crate) fn native_project_board_net_class_report(
    action: &str,
...
pub(crate) fn native_project_board_net_report(
    action: &str,
    project: &LoadedNativeProject,
    net: Net,
...
pub(crate) fn native_project_board_component_report(
    action: &str,
    project: &LoadedNativeProject,
...
pub(crate) fn native_project_board_track_report(
    action: &str,
    project: &LoadedNativeProject,
    track: Track,
...
pub(crate) fn native_project_board_via_report(
    action: &str,
    project: &LoadedNativeProject,
    via: Via,
...
pub(crate) fn native_project_board_zone_report(
    action: &str,
    project: &LoadedNativeProject,
    zone: Zone,
...
pub(crate) fn native_project_board_pad_report(
    action: &str,
    project: &LoadedNativeProject,
    pad: PlacedPad,
