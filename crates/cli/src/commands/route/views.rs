...
pub(crate) fn render_native_route_proposal_export_text(
...
pub(crate) fn render_native_route_proposal_selection_text(
...
pub(crate) fn render_native_route_proposal_explain_text(
...
pub(crate) fn render_native_route_proposal_review_text(
...
pub(crate) fn render_native_route_strategy_report_text(
...
pub(crate) fn render_native_route_strategy_compare_text(
...
pub(crate) fn render_native_route_strategy_delta_text(
...
pub(crate) fn render_native_route_strategy_batch_evaluate_text(
...
pub(crate) fn render_native_route_strategy_curated_fixture_suite_text(
...
pub(crate) fn render_native_route_strategy_curated_baseline_capture_text(
...
pub(crate) fn render_native_route_strategy_batch_result_inspection_text(
...
pub(crate) fn render_native_route_strategy_batch_result_validation_text(
...
pub(crate) fn render_native_route_strategy_batch_result_comparison_text(
...
pub(crate) fn render_native_route_strategy_batch_result_gate_text(
...
pub(crate) fn render_native_route_strategy_batch_results_index_text(
...
pub(crate) fn render_native_selected_route_proposal_export_text(
...
pub(crate) fn render_native_route_apply_selected_text(
...
pub(crate) fn render_native_route_proposal_artifact_inspection_text(
...
pub(crate) fn render_native_route_proposal_artifact_apply_text(
...
pub(crate) fn render_native_route_proposal_artifact_revalidation_text(
...
pub(crate) fn render_native_route_apply_text(report: &NativeProjectRouteApplyView) -> String {
    let mut lines = vec![
        format!("action: {}", report.action),
        format!("project_root: {}", report.project_root),
        format!("contract: {}", report.contract),
