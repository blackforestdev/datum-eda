...
use eda_engine::substrate::{
    ArtifactKind, ArtifactMetadata, OUTPUT_JOB_RUN_SCHEMA_VERSION, ObjectRevision, OutputJob,
    OutputJobLogEntry, OutputJobLogLevel, OutputJobRun, OutputJobRunStatus,
...
pub(crate) struct NativeProjectOutputJobRunView {
    ...
    pub(crate) artifact_report:
        Option<crate::commands::artifacts::artifacts::NativeProjectArtifactGenerateView>,
}
...
pub(crate) fn run_native_project_output_job(
    ...
    let artifact_report =
        match crate::commands::artifacts::artifacts::generate_native_project_artifacts(
            root,
            &output_dir,
            &include,
