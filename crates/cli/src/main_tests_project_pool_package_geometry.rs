...
#[test]
fn project_set_pool_package_courtyard_rect_authors_geometry_and_undoes() {
...
#[test]
fn project_set_pool_package_courtyard_polygon_authors_geometry_and_undoes() {
