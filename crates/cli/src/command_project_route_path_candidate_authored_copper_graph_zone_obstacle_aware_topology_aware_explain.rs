...
pub(crate) fn query_native_project_route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware_explain(
    root: &Path,
    net_uuid: Uuid,
    from_anchor_pad_uuid: Uuid,
    to_anchor_pad_uuid: Uuid,
) -> Result<RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareExplainReport> {
...
pub(crate) fn render_native_project_route_path_candidate_authored_copper_graph_zone_obstacle_aware_topology_aware_explain_text(
...
fn render_explanation_kind(
    ...
    match report.explanation_kind {
        eda_engine::board::RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareExplainKind::DeterministicPathFound => "deterministic_path_found",
        eda_engine::board::RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareTopologyAwareExplainKind::NoExistingAuthoredCopperPath => "no_existing_authored_copper_path",
    }
}
