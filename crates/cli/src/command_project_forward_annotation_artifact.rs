...
#[path = "command_project_forward_annotation_artifact_compare.rs"]
mod command_project_forward_annotation_artifact_compare;
#[path = "command_project_forward_annotation_substrate.rs"]
mod command_project_forward_annotation_substrate;
pub(crate) use command_project_forward_annotation_artifact_compare::compare_forward_annotation_proposal_artifact;
