...
pub(super) fn validate_project_json(root: &Path) -> (serde_json::Value, i32) {
...
pub(super) fn create_authored_pool_part(root: &Path) -> Uuid {
...
pub(super) fn create_project_with_attached_model(label: &str) -> (PathBuf, Uuid, PathBuf) {
