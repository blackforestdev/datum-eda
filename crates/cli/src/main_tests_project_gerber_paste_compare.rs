...
#[test]
fn project_compare_gerber_paste_layer_is_semantic_and_reports_drift() {
    let root = unique_project_root("datum-eda-cli-project-gerber-paste-compare");
    create_native_project(&root, Some("Gerber Paste Compare Demo".to_string()))
    ...
    std::fs::write(
        ...
        format!(
            ...
            to_json_deterministic(&serde_json::json!({
                "schema_version": 1,
                "uuid": Uuid::new_v4(),
                "name": "Gerber Paste Compare Demo Board",
                "stackup": {
                    "layers": [
    ...
    std::fs::write(
        &gerber_path,
        concat!(
            "G04 semantic paste compare fixture*\n",
            "%FSLAX46Y46*%\n",
            "%MOMM*%\n",
            "%LPD*%\n",
            "%ADD10C,0.450000*%\n",
    ...
    std::fs::write(
        &gerber_path,
        concat!(
            "G04 semantic paste drift fixture*\n",
            "%FSLAX46Y46*%\n",
            "%MOMM*%\n",
            "%LPD*%\n",
            "%ADD10C,0.450000*%\n",
