...
use eda_engine::board::{
    RoutePathCandidateAuthoredCopperGraphZoneAwareReport, RoutePathCandidateStatus,
};
use uuid::Uuid;
...
pub(crate) fn render_native_project_route_path_candidate_authored_copper_graph_zone_aware_text(
...
fn render_status(report: &RoutePathCandidateAuthoredCopperGraphZoneAwareReport) -> &'static str {
    match report.status {
