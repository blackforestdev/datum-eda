...
use eda_engine::board::{
    ...
    RoutePathCandidateAuthoredCopperGraphExplainReport, RoutePathCandidateStatus,
};
use uuid::Uuid;
...
) -> Result<RoutePathCandidateAuthoredCopperGraphExplainReport> {
...
fn render_status(report: &RoutePathCandidateAuthoredCopperGraphExplainReport) -> &'static str {
    match report.status {
...
fn render_kind(report: &RoutePathCandidateAuthoredCopperGraphExplainReport) -> &'static str {
