...
use eda_engine::board::{
    ...
    RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareExplainReport, RoutePathCandidateStatus,
};
use uuid::Uuid;

use super::super::{build_native_project_board, load_native_project};

pub(crate) fn query_native_project_route_path_candidate_authored_copper_graph_zone_obstacle_aware_explain(
    root: &Path,
    net_uuid: Uuid,
    from_anchor_pad_uuid: Uuid,
    to_anchor_pad_uuid: Uuid,
) -> Result<RoutePathCandidateAuthoredCopperGraphZoneObstacleAwareExplainReport> {
...
pub(crate) fn render_native_project_route_path_candidate_authored_copper_graph_zone_obstacle_aware_explain_text(
