...
pub(super) fn execute_forward_annotation_command(
    ...
    match command {
        ...
        ProjectCommands::ApplyForwardAnnotationReviewed(
            ProjectApplyForwardAnnotationReviewedArgs { path },
        ) => {
        ...
        ProjectCommands::ExportForwardAnnotationProposal(
            ProjectExportForwardAnnotationProposalArgs { path, out },
        ) => {
        ...
        ProjectCommands::InspectForwardAnnotationProposalArtifact(
            ProjectInspectForwardAnnotationProposalArtifactArgs { path },
        ) => {
        ...
        ProjectCommands::ValidateForwardAnnotationProposalArtifact(
            ProjectValidateForwardAnnotationProposalArtifactArgs { path },
        ) => {
        ...
        ProjectCommands::CompareForwardAnnotationProposalArtifact(
            ProjectCompareForwardAnnotationProposalArtifactArgs { path, artifact },
        ) => {
        ...
        ProjectCommands::PlanForwardAnnotationProposalArtifactApply(
            ProjectPlanForwardAnnotationProposalArtifactApplyArgs { path, artifact },
        ) => {
        ...
        ProjectCommands::ApplyForwardAnnotationProposalArtifact(
            ProjectApplyForwardAnnotationProposalArtifactArgs { path, artifact },
        ) => {
        ...
        ProjectCommands::ImportForwardAnnotationArtifactReview(
            ProjectImportForwardAnnotationArtifactReviewArgs { path, artifact },
        ) => {
        ...
        ProjectCommands::ReplaceForwardAnnotationArtifactReview(
            ProjectReplaceForwardAnnotationArtifactReviewArgs { path, artifact },
        ) => {
        ...
        ProjectCommands::DeferForwardAnnotationAction(
            ProjectDeferForwardAnnotationActionArgs { path, action_id },
        ) => {
            let report =
        ...
        ProjectCommands::RejectForwardAnnotationAction(
            ProjectRejectForwardAnnotationActionArgs { path, action_id },
        ) => {
            let report =
        ...
        ProjectCommands::ClearForwardAnnotationActionReview(
            ProjectClearForwardAnnotationActionReviewArgs { path, action_id },
        ) => {
